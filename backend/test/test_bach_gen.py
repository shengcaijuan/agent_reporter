...
# 主函数
async def main(
    sale_configs: List[Dict[str, Any]],
    time: str = "202601",
    ...
    if record_manager.failed_records or record_manager.pending_records:
        ...
        print(f"  python main.py --time {time}")
    
if __name__ == "__main__":
    import argparse
    from sale_list import sale_list
    parser = argparse.ArgumentParser(description="智能销售报告生成系统")

    asyncio.run(main(sale_configs=sale_list))
